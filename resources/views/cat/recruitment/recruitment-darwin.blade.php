...
@section('content')
    <header class="py-5 bg-image-full" style="background-image: url('{{asset('images/recruitment-darwin1.jpg')}}');">
    ...
    <div class="container">
        <div class="row mt-6">
        <div class="col-md-8">
            <h1 class="display-4 mb-2 blog-post-title border-bottom">Mates Group: Recruitment Solution & Labour Hire Specialist</h1>
            </div>
            <div class="col-md-4">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 blog-main text-justify">
                <div class="blog-post">
                    ...
                    <figure class="figure">
                        <img src="/images/recruitment/recruitment-darwin2.jpg" class="figure-img img-fluid rounded" alt="Recruitment Experts Darwin">
                    </figure>
