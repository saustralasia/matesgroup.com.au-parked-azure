...
@section('content')
    <div class="header-banner">
        <h1 class="white line-12 text-45" style="text-align: center;">Casual Labour Hire</h1>
    </div>
    <div class="single-content">
        ...
        <div class="single-content">
            <div class="container">
                ...
                <p style="font-size: 30px;">Job Description:</p>
                <p>
                ...
                <p style="font-size: 30px;">About the role:</p>
                <div style="margin-left: 50px; margin-bottom: 30px;">
                ...
                <p style="font-size: 30px;">Skills and experience:</p>
                <p>
