...
@section('meta_keywords', 'construction staff hiring Australia, construction staff recruitment Australia, construction staff recruitment service Australia construction labourer recruitment service australia')
    ...
    <div class="single-content">
        ...
        <div class="container">
            <div class="col-md-12" class="text-justify">
                ...
                <h2><strong>So, It's time to construct!</strong></h2>
                <p><strong>We specialise in recruiting for the property, construction, design, engineering, & resources sectors, and with recruitment specialists in each industry. We always ensure that top talent is matched with top companies.</strong></p>

                <p>Our recruitment specialists are among the leading recruiters in Australia. We provide the highest quality service, matching top talent with top companies.</p>
