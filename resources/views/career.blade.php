        ...
        <div class="row">
            ...
            <div class="col-md-8 blog-main text-justify">
                <div class="blog-post">
                    ...
                    <h3 class="black">Guidance for job seekers</h3>
                    <p>We understand that searching for a job can be challenging. In order to find the right
                        position for you, you need to be able to prove that you are the best candidate for the
                        advertised role.</p>
                    <p>
                        By following the tips below, you will ensure that you improve your chances of
                        succeeding at the interview stage.
                    </p>
                    <b>Tips and guidelines:</b>
                    <ul class="com-list1">
                    ...
                    <p><b>We specialise in labour hire services for the following industries:</b></p>
                    <ul class="com-list1">
